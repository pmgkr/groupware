        ...
        {!hideTitle && title && (
          <div className="mb-5 flex items-center has-[+nav]:mb-2">
            ...
            {!hideChildNav && childNav && childNav.length > 0 && (
              <nav className="scrollbar-hide relative flex-1 overflow-x-auto overflow-y-hidden whitespace-nowrap max-md:-mr-[18px] max-md:[touch-action:pan-x] max-md:pr-[18px] md:overflow-visible">
