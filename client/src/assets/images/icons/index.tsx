...
const Lazy_Excel = React.lazy(() => import('./excel.svg?react'));
...
const Lazy_Pdf = React.lazy(() => import('./pdf.svg?react'));
...
export const Excel: React.FC<IconProps> = Object.assign(withSuspense(Lazy_Excel), { displayName: 'Excel' });
...
export const Pdf: React.FC<IconProps> = Object.assign(withSuspense(Lazy_Pdf), { displayName: 'Pdf' });
