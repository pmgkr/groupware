  ...
  return (
    <CheckboxPrimitive.Root
      ...
      className={cn(
        ...
        variant === 'dynamic' 
          ? 'data-[state=checked]:bg-primary-blue-100 data-[state=checked]:!text-primary-blue-500 data-[state=checked]:border-primary-blue-300 data-[state=checked]:shadow-xs'
          : variant === 'dynamicBlue'
