...
const badgeVariants = cva(
  'inline-flex items-center justify-center border transition-[color,box-shadow] overflow-hidden rounded-sm px-2 py-0.5 text-xs font-normal w-fit whitespace-nowrap shrink-0 [&>svg]:size-3 gap-1 [&>svg]:pointer-events-none border-transparent  ',
  {
    variants: {
      variant: {
