...
function Input({ className, type, size = 'default', ...props }: InputProps) {
  const sizeClasses =
    size === 'sm'
      ? 'h-8 text-sm px-3 py-0.5 file:h-6 file:text-xs placeholder:text-sm' // sm 전용 스타일
      : 'h-11 text-base px-3 py-1 file:h-7 file:text-sm placeholder:text-base'; // default 스타일
