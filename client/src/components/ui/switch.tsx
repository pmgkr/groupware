...
const switchVariants = cva(
  'peer inline-flex h-[1.5rem] w-11 shrink-0 items-center rounded-full border border-transparent shadow-xs transition-all outline-none focus-visible:ring-[3px] disabled:cursor-not-allowed disabled:opacity-50 focus-visible:border-ring focus-visible:ring-ring/50',
  {
    variants: {
      variant: {
        default: [
      ...
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          ...
          props.disabled
            ...
            : ['data-[state=checked]:bg-[color:var(--color-gray-50)]', 'data-[state=unchecked]:bg-[color:var(--color-gray-50)]']
        )}
      />
      ...
      <SwitchWrapper variant={props.disabled ? undefined : variant}>
        ...
        <label
          className={cn(
            ...
            props.disabled ? 'cursor-not-allowed text-gray-400' : 'text-gray-500',
