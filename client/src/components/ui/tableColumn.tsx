...
export function TableColumn({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="tableColumn-container"
      className={cn('flex w-full overflow-hidden rounded-2xl border border-gray-300', className)}
      {...props}
    />
  );
}
...
export function TableColumnHeaderCell({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('flex items-center border-b border-gray-300 px-4 py-2 last:border-b-0', className)}
      {...props}
    />
  );
}
...
export function TableColumnCell({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      ...
      className={cn('flex items-center border-b border-gray-300 px-4 py-2 text-gray-800 last:border-b-0', className)}
      {...props}
    />
  );
}
