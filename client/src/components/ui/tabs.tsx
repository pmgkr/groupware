...
function TabsList({ className, ...props }: React.ComponentProps<typeof TabsPrimitive.List>) {
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        'inline-flex w-fit items-center justify-center rounded-sm bg-gray-300 p-1 px-1.5 text-gray-500 max-sm:block max-sm:w-full',
        className
      )}
      {...props}
    />
