  ...
  return (
    <a
      ...
      className={cn(
        ...
        // 커스텀 스타일 추가
        isActive
          ? ':bg-white text-white [&]:border-[color:var(--color-primary-blue-500)] [&]:bg-[color:var(--color-primary-blue-500)] [&:hover]:border-[color:var(--color-primary-blue-500)] [&:hover]:bg-[color:var(--color-primary-blue-500)] [&:hover]:text-white'
...
function PaginationPrevious({ className, ...props }: React.ComponentProps<typeof PaginationLink>) {
  return (
    <PaginationLink
      ...
      size="default"
      className={cn('gap-1 px-2.5 text-gray-950 sm:pl-2.5', className)}
      {...props}>
      <ChevronLeftIcon />
