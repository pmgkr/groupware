  ...
  return (
    <a
      ...
      className={cn(
        ...
        // 커스텀 스타일 추가
        isActive
          ? ':bg-white text-[color:var(--color-primary-blue-500)] [&]:border-[color:var(--color-primary-blue-500)] [&]:bg-white [&:hover]:border-[color:var(--color-primary-blue-500)] [&:hover]:bg-[color:var(--color-primary-blue-500)]'
