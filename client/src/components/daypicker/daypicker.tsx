    ...
    <RDPDayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          ...
          variant === 'dashboard' && 'text-primary-blue text-lg font-bold',
        ...
        weekday: cn(
          ...
          // Dashboard Daypicker 스타일 추가
          variant === 'dashboard' && 'text-primary py-1.5',
        ...
        day: cn(
          ...
          // Dashboard Daypicker 스타일 추가
          variant === 'dashboard' && 'bg-dashboard-td text-dashboard-td aspect-[1.5/1]',
        ...
        today: cn(
          ...
          // Dashboard Daypicker 스타일 추가
          variant === 'dashboard' && 'group bg-inherit text-primary-foreground',
      ...
      components={{
        ...
        DayButton: (props) => <DayPickerDayButton {...props} variant={variant ?? undefined} />,
        WeekNumber: ({ children, ...props }) => {
          return (
            <td {...props} className={cn('flex size-(--cell-size) items-center justify-center text-center')}>
              {children}
            </td>
          );
        },
...
function DayPickerDayButton({
  ...
  variant,
  ...props
}: React.ComponentProps<typeof DayButton> & { variant?: string }) {
  const defaultClassNames = getDefaultClassNames();
...
export { DayPicker, DayPickerDayButton, dayPickerVariants };
