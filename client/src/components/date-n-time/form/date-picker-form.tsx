          ...
          render={({ field }) => {
            ...
            return (
              <FormItem className="flex flex-col">
                  ...
                  <PopoverTrigger asChild>
                    <FormControl>
                      <Button
                        ...
                        {field.value ? format(field.value, 'yyyy년 M월 d일 EEEE', { locale: ko }) : <span>{placeholder}</span>}
                ...
                <FormDescription>
                  provided by{' '}
                  <a href="https://ui.shadcn.com/docs/components/date-picker#form" target="_blank" className="underline">
                    shadcn
                  </a>
                </FormDescription>
                <FormMessage />
