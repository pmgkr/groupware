...
const multiSelectVariants = cva('m-1 transition-all duration-300 ease-in-out', {
  variants: {
    variant: {
      ...
      secondary: 'border-foreground/10 bg-[var(--color-gray-50)] text-[var(--color-primary-purple-500)]',
      destructive: 'border-transparent bg-destructive text-[var(--color-negative-base)] hover:bg-destructive/80',
      inverted: 'inverted',
    },
    badgeAnimation: {
          ...
          .map((group) => ({
            ...
            options: group.options.filter((option) => {
              ...
              return (
                ...
                // 초성 검색 지원 (한글인 경우)
                (/[가-힣]/.test(searchValue) && normalizedLabel.includes(searchValue.toLowerCase())) ||
          ...
          <PopoverContent
            ...
            <Command shouldFilter={false}>
              ...
              <CommandList
                ...
                <CommandEmpty>{emptyIndicator || '일치하는 결과가 없습니다.'}</CommandEmpty>{' '}
                      ...
                      {group.options.map((option) => {
                        ...
                        return (
                          <CommandItem
                            ...
                            className={cn('cursor-pointer py-2 leading-[1.3]', option.disabled && 'cursor-not-allowed opacity-50')}
