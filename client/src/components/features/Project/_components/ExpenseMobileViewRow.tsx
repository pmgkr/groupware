...
export default function ExpenseMobileViewRow({ item, isEstimate, onAddInfo, alreadyMatched }: ExpenseMobileViewRowProps) {
  return (
      ...
      {isEstimate ? (
        <dl className="flex justify-between py-1">
          ...
          <dd className="text-right text-sm font-medium text-gray-700">
            {alreadyMatched ? <span>매칭완료</span> : <span className="text-primary">매칭필요</span>}
          </dd>
        </dl>
      ) : (
        <dl className="flex justify-between py-1">
