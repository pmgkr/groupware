  ...
  render: (args) => (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-muted-foreground text-sm">24시간 형식으로 날짜와 시간을 선택할 수 있는 폼 컴포넌트입니다.</p>
      </div>
      <DateTimePicker24hForm {...args} />
    </div>
  ),
  ...
  render: (args) => (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-muted-foreground text-sm">시스템 작업의 날짜와 시간을 24시간 형식으로 선택해주세요.</p>
      </div>
      <DateTimePicker24hForm {...args} />
    </div>
  ),
  ...
  render: (args) => (
    <div className="space-y-4">
      <div>
        ...
        <p className="text-muted-foreground text-sm">날짜와 시간을 선택하지 않고 제출하면 에러 메시지가 표시됩니다.</p>
      </div>
      <DateTimePicker24hForm {...args} />
    </div>
  ),
  ...
  render: (args) => (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm">12시간 형식과 24시간 형식의 차이를 확인할 수 있습니다.</p>
      </div>
