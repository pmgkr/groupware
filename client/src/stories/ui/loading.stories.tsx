    ...
    const Content = () => {
      ...
      return (
        <div className="flex h-[100vh] w-[100vw] flex-col items-center justify-center gap-4">
          <Button onClick={test}>타이틀+텍스트 로딩 표시</Button>
        </div>
      );
    };
...
export const WithTitleOnly: Story = {
  render: () => {
    const Content = () => {
      ...
      return (
        <div className="flex h-[100vh] w-[100vw] flex-col items-center justify-center gap-4">
          <Button onClick={test}>타이틀만 로딩 표시</Button>
        </div>
      );
    };
...
export const IconOnly: Story = {
  render: () => {
    const Content = () => {
      ...
      return (
        <div className="flex h-[100vh] w-[100vw] flex-col items-center justify-center gap-4">
          <Button onClick={test}>아이콘만 로딩 표시</Button>
        </div>
      );
    };
...
export const DirectUseWithTitleAndMessage: Story = {
  ...
  render: () => (
    <div style={{ position: 'relative', minHeight: '500px', width: '100%' }}>
      <Loading title="등록하신 <em>첨부파일</em>을 <br><em>서버로 배송 중</em> 입니다." message="새로고침을 누르면 처음부터 다시" />
    </div>
  ),
};
...
export const DirectUseWithTitleOnly: Story = {
  ...
  render: () => (
    <div style={{ position: 'relative', minHeight: '500px', width: '100%' }}>
      <Loading title="등록하신 <em>첨부파일</em>을 <br><em>서버로 배송 중</em> 입니다." />
    </div>
  ),
};
